...
class QR_generator:
    def __init__(self,root):
        ...
        self.root.title(" QR generator | Developed By GRP-8 (O2)")
        self.root.resizable(False, False)

        title = Label(self.root, text="        A simple QR Code Generator                                                                                                                                                                                                                                           by Grp - 8(O2) ", font=('arial', 10),anchor='w').place(x=0, y=0, relwidth = 1)
